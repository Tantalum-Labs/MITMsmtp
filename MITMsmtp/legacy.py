...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
This is the legacy command line interface for MITMsmtp. It exposes the
original SMTP-only feature set (no DNS responder, SMB capture or NTLM relay).
For the full Tantalum Labs runner use `python3 -m MITMsmtp` / the `MITMsmtp`
console command, or `python3 MITMsmtp/MITMsmtp.py`.
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
